...
xmlr.reflect(
    Inertial, params=[xmlr.Element("mass", float), xmlr.Element("inertia", Inertia), pose_element]
)
...
xmlr.reflect(
    Cylinder, tag="cylinder", params=[xmlr.Element("radius", float), xmlr.Element("length", float)]
)
...
xmlr.reflect(
    Mesh,
    tag="mesh",
    params=[xmlr.Element("filename", str), xmlr.Element("scale", "vector3", required=False)],
)
...
xmlr.reflect(
    Script, tag="script", params=[xmlr.Element("name", str, False), xmlr.Element("uri", str, False)]
)
...
xmlr.reflect(
    Material, tag="material", params=[name_attribute, xmlr.Element("script", Script, False)]
)
...
xmlr.reflect(
    Dynamics,
    tag="dynamics",
    params=[xmlr.Element("damping", float, False), xmlr.Element("friction", float, False)],
)
